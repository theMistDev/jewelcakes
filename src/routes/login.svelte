...
<svelte:head>
	<title>Sign in • MistDev</title>
</svelte:head>

 <section class="overflow-hidden">
            <div class="flex min-h-screen overflow-hidden">
              <div class="relative flex-1 hidden w-0 overflow-hidden lg:block">
                <img class="absolute inset-0 object-cover w-full h-full bg-black" src="https://d33wubrfki0l68.cloudfront.net/1a058aec6e3d81efe3ac4ca6366b40574876f6bc/32bc1/images/placeholders/rectanglewide.svg" alt="">
              </div>
              <div class="
            flex flex-col
            justify-center
          ...
          ">
                <div class="w-full max-w-xl mx-auto lg:w-96">
                  <div>
                    <a href="/" class="text-blue-600 text-medium">MistDev</a>
                    <h2 class="mt-6 text-3xl font-extrabold text-neutral-600"> Sign In. </h2>
                  </div>
                  <div class="mt-8">
                    <div class="mt-6">
                      <form method="POST" class="space-y-6" on:submit|preventDefault={login}>
                        <div>
                      ...
                      <div class="relative my-4">
                        ...
                        <div class="relative flex justify-center text-sm">
                          <span class="px-2 text-neutral-600 bg-white dark:bg-slate-900"> Or continue with </span>
                        </div>
                      </div>
                      <div>
                        <button type="submit" class="
